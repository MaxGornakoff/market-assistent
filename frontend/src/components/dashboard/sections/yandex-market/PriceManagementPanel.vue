  ...
  <div class="grid gap-5">
      ...
      >
        ...
        >
          ...
          <div class="mt-5 flex justify-end gap-2">
            ...
            <button
              type="button"
              class="rounded-xl bg-rose-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
              :disabled="isDeletingProductId === productPendingDelete.id"
    ...
    <div class="rounded-2xl border border-slate-200 bg-slate-50 p-5">
      ...
      <div class="mt-5 relative" ref="searchContainer">
        <label class="block">
          <span class="mb-1 block text-sm font-medium text-slate-700">Найди и добавь товар для отслеживания</span>
          <input
            v-model="searchQuery"
            type="text"
            class="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
        ...
        <table class="min-w-full text-left text-sm">
          <thead>
            <tr class="border-b border-slate-200 text-slate-500">
              <th class="px-3 py-3 font-medium">Название</th>
              <th class="px-3 py-3 font-medium">Offer ID</th>
              ...
              <th class="px-3 py-3 font-medium">Добавлен</th>
            </tr>
          </thead>
          <tbody>
            <tr
